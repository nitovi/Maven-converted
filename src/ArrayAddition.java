...
public class ArrayAddition {
		...
		public static void main(String[] args) {
			...
			System.out.println("Enter the elements for first array1");
			for(int i=0;i<arr1.length;i++) {
				arr1[i]=sc.nextInt();
			}
			System.out.println("Enter the size of second array1");
			int second = sc.nextInt();
			int arr2[] = new int[second];
			System.out.println("Enter the elements for second array1");
